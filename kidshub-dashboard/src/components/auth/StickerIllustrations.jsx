 ...
 * flowers) used as the background decoration layer on the auth pages.
 *
 ...
 *
 * Why custom inline SVG rather than a stock pack:
 *   - We don't ship third-party characters (no IP exposure on the
 *     "minions / anime" idea the owner originally floated — same
 *     playful vibe, fully original artwork).
 *   - Inline SVG can be opacity-tinted from the parent so the same
 *     drawings can serve both as foreground mascots (full opacity)
 *     and as background scatter (reduced opacity) without two asset
 *     sets.
 *   - Total SVG payload across the 6 designs is ~7KB, smaller than
 *     loading a single PNG mascot.
 *
 * Each component is a stand-alone <svg> with a hard-coded viewBox.
 * Callers pass `width` (defaults to a sensible per-illustration size)
 * + a `className` for animation / opacity / positioning.
 */
 ...
 */
export function DinoBlue({ width = 150, className = '', style }) {
  return (
    <svg
      viewBox="0 0 160 120"
      width={width}
      ...
      style={style}
      aria-hidden="true">
      {/* Tail — curls up, ends in a soft point */}
      <path
      ...
      {/* White polka dots — scattered, varying sizes */}
      ...
      {/* Subtle darker spots (saddle-feel) */}
 ...
 */
export function DinoPink({ width = 130, className = '', style }) {
  return (
    <svg
      viewBox="0 0 160 120"
      width={width}
 ...
 */
export function Stegosaurus({ width = 140, className = '', style }) {
  return (
    <svg
      viewBox="0 0 150 110"
      width={width}
      ...
      {/* Back plates — 4 triangles, slightly varying sizes */}
 ...
 */
export function Daisy({ width = 80, className = '', style }) {
  return (
    <svg
      viewBox="0 0 80 110"
      width={width}
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      {/* 6 round white petals — overlap the center, then the yellow
          disc sits on top so they form a clean daisy shape. */}
 ...
 */
export function Tulip({ width = 60, className = '', style }) {
  return (
    <svg
      viewBox="0 0 60 110"
      width={width}
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      {/* Front petal — lighter for dimension */}
      <path
 ...
 */
export function Sunflower({ width = 90, className = '', style }) {
  return (
    <svg
      viewBox="0 0 90 120"
      width={width}
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      {/* 8 yellow petals around (45, 32), 45° apart. Petals overlap
          the center, then the brown disc sits on top. */}
