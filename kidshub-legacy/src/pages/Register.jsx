...
import { Baby, Mail, Lock, Eye, EyeOff, ArrowRight, Loader2, User, Phone } from 'lucide-react';
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20 text-white">
          ...
          <h2 className="text-3xl xl:text-4xl font-bold mb-4 leading-tight">
            Join KidsHub<br />Parent Portal
          </h2>
          <p className="text-lg text-white/80 mb-8 max-w-md">
            Create your account to stay connected with your child's daily 
            activities, milestones, and communicate with caregivers.
          </p>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-white/90">Free to use for parents</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-white/20 flex items-center justify-center">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              ...
              <span className="text-white/90">Instant notifications</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-white/20 flex items-center justify-center">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="bg-white rounded-3xl shadow-soft-xl p-8 sm:p-10">
            <div className="text-center mb-8">
              ...
              <p className="text-surface-500 mt-2">
                {step === 1 ? 'Enter your personal details' : 'Set up your password'}
              </p>
            </div>
