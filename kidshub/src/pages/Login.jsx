      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20 text-white">
          ...
          <h2 className="text-3xl xl:text-4xl font-bold mb-4 leading-tight">
            Stay Connected<br />With Your Child
          </h2>
          <p className="text-lg text-white/80 mb-8 max-w-md">
            Get real-time updates, photos, and communicate with your child's 
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-white/90">Real-time activity updates</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-white/20 flex items-center justify-center">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              ...
              <span className="text-white/90">Daily photos & milestones</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-white/20 flex items-center justify-center">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              ...
              <span className="text-white/90">Direct messaging with teachers</span>
            </div>
          </div>
        </div>
      </div>
