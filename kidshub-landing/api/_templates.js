...
// PNG (not SVG) because Gmail/Outlook/Yahoo strip <svg>. Generated by
// `npm run build:icons` from brand/kidshub-logo.svg into landing/assets.
const LOGO_URL = 'https://getkidshub.com/assets/kidshub-logo.png';
                ...
                <tr>
                  <td style="vertical-align:middle;">
                    <a href="https://getkidshub.com" style="text-decoration:none;display:inline-flex;align-items:center;gap:10px;">
                      <img src="${LOGO_URL}" alt="" width="34" height="34" style="display:inline-block;width:34px;height:34px;border-radius:10px;vertical-align:middle;border:0;" />
                      <span style="font-size:20px;font-weight:700;color:${TEXT_DARK};letter-spacing:-0.01em;vertical-align:middle;">KidsHub</span>
                    </a>
                  </td>
                </tr>
              </table>
