// Comprehensive mock data for KidsHub daycare management system
...
export const activityTypes = {
  meal: { label: 'Meal', icon: '🍽️', color: 'warning' },
  snack: { label: 'Snack', icon: '🍎', color: 'warning' },
  nap: { label: 'Nap', icon: '😴', color: 'info' },
  diaper: { label: 'Diaper', icon: '👶', color: 'accent' },
  potty: { label: 'Potty', icon: '🚽', color: 'accent' },
  activity: { label: 'Activity', icon: '🎨', color: 'success' },
  outdoor: { label: 'Outdoor Play', icon: '🌳', color: 'success' },
  learning: { label: 'Learning', icon: '📚', color: 'brand' },
  mood: { label: 'Mood Check', icon: '😊', color: 'brand' },
  incident: { label: 'Incident', icon: '⚠️', color: 'danger' },
  medication: { label: 'Medication', icon: '💊', color: 'danger' },
  milestone: { label: 'Milestone', icon: '⭐', color: 'warning' },
  photo: { label: 'Photo', icon: '📸', color: 'info' },
  note: { label: 'Note', icon: '📝', color: 'neutral' },
  checkin: { label: 'Check-in', icon: '✅', color: 'success' },
  checkout: { label: 'Check-out', icon: '👋', color: 'info' },
};
...
export const activities = [
  // Today's activities
  {
    ...
    details: { droppedOffBy: 'Jennifer Singh (Mom)' },
  },
  {
    id: 'activity-2',
    childId: 'child-1',
    ...
    details: { amount: 'All', mealType: 'Breakfast' },
  },
  {
    id: 'activity-3',
    childId: 'child-1',
    ...
    staffId: 'staff-2',
    notes: 'Wet diaper, changed successfully',
  ...
  },
  {
    ...
    staffId: 'staff-1',
    notes: 'Played with building blocks and made a tower!',
    details: { activityName: 'Block Building' },
  },
  {
    id: 'activity-5',
    childId: 'child-2',
    type: 'checkin',
    timestamp: getDate(0, 7, 45),
    staffId: 'staff-1',
    notes: 'Early arrival, dad mentioned he had a restless night',
    details: { droppedOffBy: 'Kevin Chen (Dad)' },
  },
  {
    id: 'activity-6',
    childId: 'child-2',
    ...
    staffId: 'staff-2',
    notes: 'Started nap early due to tiredness',
    details: { startTime: getDate(0, 9, 0), duration: null },
  },
  {
    id: 'activity-7',
    childId: 'child-3',
    ...
    staffId: 'staff-3',
    notes: 'Happy morning!',
    details: { droppedOffBy: 'Maria Garcia (Mom)' },
  },
  {
    id: 'activity-8',
    childId: 'child-3',
    ...
    timestamp: getDate(0, 9, 0),
    staffId: 'staff-3',
    notes: 'Practiced counting to 10 with colored blocks',
    details: { subject: 'Math', skill: 'Counting' },
  },
  {
    id: 'activity-9',
    childId: 'child-4',
    ...
    timestamp: getDate(0, 8, 30),
    staffId: 'staff-5',
    notes: 'Morning feeding supplies received',
    details: { droppedOffBy: 'Maria Garcia (Mom)' },
  },
  {
    id: 'activity-10',
    ...
    timestamp: getDate(0, 9, 0),
    staffId: 'staff-5',
    notes: 'Bottle feeding - 4oz breast milk',
    details: { amount: '4oz', mealType: 'Bottle' },
  },
  {
    id: 'activity-11',
    childId: 'child-5',
    type: 'checkin',
    timestamp: getDate(0, 7, 30),
    staffId: 'staff-3',
    notes: 'First one here today!',
    details: { droppedOffBy: 'Susan Williams (Mom)' },
  },
  {
    id: 'activity-12',
    childId: 'child-5',
    ...
    timestamp: getDate(0, 9, 15),
    staffId: 'staff-4',
    notes: 'Enjoyed playground time, used the swings',
    details: { location: 'Main Playground', duration: '30 min' },
  },
  {
    id: 'activity-13',
    childId: 'child-1',
    ...
    staffId: 'staff-1',
    notes: 'Very happy and engaged today!',
  ...
  },
  {
    ...
    staffId: 'staff-3',
    notes: 'Emma wrote her full name independently for the first time!',
    details: { milestone: 'Writing', description: 'Wrote full name' },
  },
  // Yesterday's activities
  {
    ...
    staffId: 'staff-1',
    notes: 'Arts and crafts time - made a beautiful painting!',
  ...
  },
  {
    ...
    childId: 'child-3',
    type: 'incident',
    timestamp: getDate(1, 11, 30),
    staffId: 'staff-3',
    notes: 'Minor bump on forehead from falling while running. Applied ice pack. Child was fine after 5 minutes.',
    details: { severity: 'Minor', treatment: 'Ice pack', parentNotified: true },
  },
];
...
export const messages = [
  {
    ...
    childId: 'child-1',
    timestamp: getDate(0, 7, 30),
    content: "Good morning! Just wanted to let you know Ava had a great breakfast at home today. She's excited about the art project you mentioned!",
    read: true,
  },
  {
    id: 'msg-2',
    ...
    content: "Thanks for letting me know, Jennifer! Ava arrived happy and went straight to play with her friends. We'll start the art project after morning circle time. I'll send photos!",
    read: true,
  },
  {
    id: 'msg-3',
    ...
    recipientId: 'staff-1',
    childId: 'child-2',
    timestamp: getDate(0, 6, 50),
    content: "Hi, Liam had a restless night so he might be tired today. His dad will drop him off early. Please let him nap if he seems drowsy.",
    read: true,
  },
  {
    id: 'msg-4',
    ...
    senderId: 'staff-1',
    senderType: 'staff',
    recipientId: 'parent-3',
    childId: 'child-2',
    timestamp: getDate(0, 9, 30),
    content: "Thanks for the heads up, Linda. Kevin mentioned it at drop-off too. Liam did seem tired so we let him start his nap a bit early. He's sleeping peacefully now. 😊",
    read: false,
  },
  {
    id: 'msg-5',
    ...
    senderId: 'staff-3',
    senderType: 'staff',
    recipientId: 'parent-5',
    childId: 'child-3',
    timestamp: getDate(1, 11, 45),
    content: "Hi Maria, I wanted to let you know that Sofia had a small bump on her forehead during free play. She was running and tripped. We applied an ice pack and she's completely fine now - back to playing happily! Just wanted to give you a heads up.",
    read: true,
  },
  {
    id: 'msg-6',
    ...
    recipientId: 'staff-3',
    childId: 'child-3',
    timestamp: getDate(1, 12, 0),
    content: "Thank you so much for letting me know right away, Emily! I appreciate you keeping such good care of her. Is there any bruising?",
    read: true,
  },
  {
    id: 'msg-7',
    ...
    recipientId: 'parent-5',
    childId: 'child-3',
    timestamp: getDate(1, 12, 15),
    content: "Just a tiny red spot that's already fading. She's been running around happily all afternoon! 💕",
    read: true,
  },
];
...
export const announcements = [
  ...
  },
  {
    ...
    content: 'Reminder: KidsHub will be closed on Monday, April 15th for staff professional development. We appreciate your understanding!',
    author: 'staff-6',
  ...
  {
    id: 'announce-3',
    title: 'New Spring Menu',
    content: "We're excited to introduce our new spring menu featuring fresh, seasonal ingredients! Check your email for the full menu.",
    author: 'staff-6',
    timestamp: getDate(3, 11, 0),
    priority: 'normal',
    targetAudience: 'all',
  },
];

// Daily schedules by classroom
...
// Utility functions
export const getChildById = (id) => children.find((c) => c.id === id);
export const getStaffById = (id) => staff.find((s) => s.id === id);
export const getClassroomById = (id) => classrooms.find((c) => c.id === id);
export const getParentById = (id) => parents.find((p) => p.id === id);

export const getChildrenByClassroom = (classroomId) =>
  children.filter((c) => c.classroom === classroomId);

export const getStaffByClassroom = (classroomId) =>
  staff.filter((s) => s.classroom === classroomId);

export const getActivitiesByChild = (childId) =>
  activities.filter((a) => a.childId === childId).sort((a, b) => new Date(b.timestamp) - new Date(a.timestamp));

export const getMessagesByChild = (childId) =>
  messages.filter((m) => m.childId === childId).sort((a, b) => new Date(a.timestamp) - new Date(b.timestamp));

export const getTodaysActivities = () => {
  const today = new Date();
  today.setHours(0, 0, 0, 0);
  return activities.filter((a) => new Date(a.timestamp) >= today).sort((a, b) => new Date(b.timestamp) - new Date(a.timestamp));
};

export const getCheckedInChildren = () =>
  children.filter((c) => c.status === 'checked-in');

export const getAbsentChildren = () =>
  children.filter((c) => c.status === 'absent');

// Dashboard stats
export const getDashboardStats = () => ({
  totalChildren: children.length,
  checkedIn: getCheckedInChildren().length,
  absent: getAbsentChildren().length,
  totalStaff: staff.length,
  staffOnDuty: staff.filter((s) => s.status === 'online').length,
  activitiesLogged: getTodaysActivities().length,
  unreadMessages: messages.filter((m) => !m.read && m.senderType === 'parent').length,
});
